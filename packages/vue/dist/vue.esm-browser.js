...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  const shapeFlag = isString(type) ? ShapeFlags.ELEMENT : isSuspense(type) ? ShapeFlags.SUSPENSE : isTeleport(type) ? ShapeFlags.TELEPORT : isObject(type) ? ShapeFlags.STATEFUL_COMPONENT : isFunction(type) ? ShapeFlags.FUNCTIONAL_COMPONENT : 0;
...
function cloneVNode(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    // fast paths only.
    patchFlag: extraProps && vnode.type !== Fragment ? patchFlag === -1 ? PatchFlags.FULL_PROPS : patchFlag | PatchFlags.FULL_PROPS : patchFlag,
...
const State = {
  ...
  "8": "BeforeClosingTagName",
  "InClosingTagName": 9,
  "9": "InClosingTagName",
  "AfterClosingTagName": 10,
  "10": "AfterClosingTagName",
  "BeforeAttrName": 11,
  "11": "BeforeAttrName",
  "InAttrName": 12,
  "12": "InAttrName",
  ...
  "22": "BeforeDeclaration",
  "InDeclaration": 23,
  "23": "InDeclaration",
  "InProcessingInstruction": 24,
  "24": "InProcessingInstruction",
  "BeforeComment": 25,
  "25": "BeforeComment",
  "CDATASequence": 26,
  "26": "CDATASequence",
...
class Tokenizer {
    ...
    if (c === 33) {
      ...
      if (this.mode === 0) {
        ...
        if (lower === 116) {
          ...
          this.state = lower === 115 ? State.BeforeSpecialS : 6;
        }
      } else {
        this.state = 6;
      }
  ...
  stateBeforeClosingTagName(c) {
    if (isWhitespace(c)) ; else if (c === 62) {
      ...
      this.state = isTagStartChar(c) ? State.InClosingTagName : 27;
      this.sectionStart = this.index;
    }
  }
  ...
  stateBeforeDeclaration(c) {
    if (c === 91) {
      ...
      this.state = c === 45 ? State.BeforeComment : 23;
    }
  }
  ...
  ondirarg(start, end) {
    ...
    if (inVPre) {
      ...
      currentProp.arg = createExp(
        ...
        isStatic,
        getLoc(start, end),
        isStatic ? ConstantTypes.CAN_STRINGIFY : 0
      );
    }
  },
...
function baseParse(input, options) {
  ...
  tokenizer.mode = currentOptions.parseMode === "html" ? ParseMode.HTML : currentOptions.parseMode === "sfc" ? ParseMode.SFC : 0;
...
const transformFor = createStructuralDirectiveTransform(
  ...
  (node, dir, context) => {
    ...
    return processFor(node, dir, context, (forNode) => {
      ...
      const fragmentFlag = isStableFragment ? PatchFlags.STABLE_FRAGMENT : keyProp ? PatchFlags.KEYED_FRAGMENT : 256;
...
function buildSlots(node, context, buildSlotFn = buildClientSlotFn) {
  ...
  const slotFlag = hasDynamicSlots ? SlotFlags.DYNAMIC : hasForwardedSlots(node.children) ? SlotFlags.FORWARDED : 1;
    ...
    if (prop.type === 6) {
      ...
      if (!arg && (isVBind || isVOn)) {
        ...
        if (exp) {
          ...
          context.onError(
            createCompilerError(
              isVBind ? ErrorCodes.X_V_BIND_NO_EXPRESSION : 35,
              loc
            )
          );
        }
...
export { BaseTransition, BaseTransitionPropsValidators, Comment, DeprecationTypes, EffectScope, ErrorCodes$1 as ErrorCodes, ErrorTypeStrings, Fragment, KeepAlive, ReactiveEffect, Static, Suspense, Teleport, Text, TrackOpTypes, Transition, TransitionGroup, TriggerOpTypes, VueElement, assertNumber, callWithAsyncErrorHandling, callWithErrorHandling, camelize, capitalize, cloneVNode, compatUtils, compileToFunction as compile, computed, createApp, createBlock, createCommentVNode, createElementBlock, createBaseVNode as createElementVNode, createHydrationRenderer, createPropsRestProxy, createRenderer, createSSRApp, createSlots, createStaticVNode, createTextVNode, createVNode, customRef, defineAsyncComponent, defineComponent, defineCustomElement, defineEmits, defineExpose, defineModel, defineOptions, defineProps, defineSSRCustomElement, defineSlots, devtools, effect, effectScope, getCurrentInstance, getCurrentScope, getTransitionRawChildren, guardReactiveProps, h, handleError, hasInjectionContext, hydrate, initCustomFormatter, initDirectivesForSSR, inject, isMemoSame, isProxy, isReactive, isReadonly, isRef, isRuntimeOnly, isShallow, isVNode, markRaw, mergeDefaults, mergeModels, mergeProps, nextTick, normalizeClass, normalizeProps, normalizeStyle, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onScopeDispose, onServerPrefetch, onUnmounted, onUpdated, openBlock, popScopeId, provide, proxyRefs, pushScopeId, queuePostFlushCb, reactive, readonly, ref, registerRuntimeCompiler, render, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveFilter, resolveTransitionHooks, setBlockTracking, setDevtoolsHook, setTransitionHooks, shallowReactive, shallowReadonly, shallowRef, ssrContextKey, ssrUtils, stop, toDisplayString, toHandlerKey, toHandlers, toRaw, toRef, toRefs, toValue, transformVNodeArgs, triggerRef, unref, useAttrs, useCssModule, useCssVars, useModel, useSSRContext, useSlots, useTransitionState, vModelCheckbox, vModelDynamic, vModelRadio, vModelSelect, vModelText, vShow, version, warn, watch, watchEffect, watchPostEffect, watchSyncEffect, withAsyncContext, withCtx, withDefaults, withDirectives, withKeys, withMemo, withModifiers, withScopeId };
